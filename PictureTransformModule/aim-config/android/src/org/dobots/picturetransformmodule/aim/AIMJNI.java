...
public class AIMJNI {
  ...
  public final static native void AndroidOutImageRead_t_success_set(long jarg1, AndroidOutImageRead_t jarg1_, boolean jarg2);
  public final static native boolean AndroidOutImageRead_t_success_get(long jarg1, AndroidOutImageRead_t jarg1_);
  public final static native void AndroidOutImageRead_t_val_set(long jarg1, AndroidOutImageRead_t jarg1_, long jarg2, vector_int jarg2_);
  public final static native long AndroidOutImageRead_t_val_get(long jarg1, AndroidOutImageRead_t jarg1_);
  public final static native long new_AndroidOutImageRead_t();
  public final static native void delete_AndroidOutImageRead_t(long jarg1);
  public final static native void delete_PictureTransformModule(long jarg1);
  public final static native void PictureTransformModule_Init(long jarg1, PictureTransformModule jarg1_, long jarg2);
  public final static native long PictureTransformModule_GetParam(long jarg1, PictureTransformModule jarg1_);
  public final static native void PictureTransformModule_Tick(long jarg1, PictureTransformModule jarg1_);
  public final static native boolean PictureTransformModule_Stop(long jarg1, PictureTransformModule jarg1_);
  public final static native long PictureTransformModule_readInImage__SWIG_0(long jarg1, PictureTransformModule jarg1_, boolean jarg2);
  public final static native long PictureTransformModule_readInImage__SWIG_1(long jarg1, PictureTransformModule jarg1_);
  public final static native void PictureTransformModule_androidWriteInImage(long jarg1, PictureTransformModule jarg1_, long jarg2, vector_int jarg2_);
  public final static native boolean PictureTransformModule_writeOutImage(long jarg1, PictureTransformModule jarg1_, long jarg2, vector_int jarg2_);
  public final static native long PictureTransformModule_androidReadOutImage(long jarg1, PictureTransformModule jarg1_);
  public final static native long new_PictureTransformModuleExt();
  public final static native void delete_PictureTransformModuleExt(long jarg1);
  public final static native void PictureTransformModuleExt_Tick(long jarg1, PictureTransformModuleExt jarg1_);
  public final static native boolean PictureTransformModuleExt_Stop(long jarg1, PictureTransformModuleExt jarg1_);
  public final static native long PictureTransformModuleExt_SWIGUpcast(long jarg1);
}
