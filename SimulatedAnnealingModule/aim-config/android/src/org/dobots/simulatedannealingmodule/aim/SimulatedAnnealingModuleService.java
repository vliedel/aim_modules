package org.dobots.simulatedannealingmodule.aim;
...
public class SimulatedAnnealingModuleService extends Service {
	private static final String TAG = "SimulatedAnnealingModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			SimulatedAnnealingModule aim = new SimulatedAnnealingModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("SimulatedAnnealingModule");
	}
