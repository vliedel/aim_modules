package org.dobots.simulatedannealingmodule;
...
import org.dobots.simulatedannealingmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "SimulatedAnnealingModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.simulatedannealingmodule", "org.dobots.simulatedannealingmodule.aim.SimulatedAnnealingModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (SimulatedAnnealingModuleService.class.getName().equals(service.service.getClassName())) {
