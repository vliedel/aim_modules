package org.dobots.swiftenmodule;
...
import org.dobots.swiftenmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "SwiftenModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.swiftenmodule", "org.dobots.swiftenmodule.aim.SwiftenModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (SwiftenModuleService.class.getName().equals(service.service.getClassName())) {
