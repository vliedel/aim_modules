package org.dobots.swiftenmodule.aim;
...
public class SwiftenModuleService extends Service {
	private static final String TAG = "SwiftenModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			SwiftenModule aim = new SwiftenModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("SwiftenModule");
	}
