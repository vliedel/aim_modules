package org.dobots.monotonesweepmodule;
...
import org.dobots.monotonesweepmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "MonotoneSweepModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.monotonesweepmodule", "org.dobots.monotonesweepmodule.aim.MonotoneSweepModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (MonotoneSweepModuleService.class.getName().equals(service.service.getClassName())) {
