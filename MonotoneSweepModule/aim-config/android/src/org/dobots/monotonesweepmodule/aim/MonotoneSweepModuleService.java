package org.dobots.monotonesweepmodule.aim;
...
public class MonotoneSweepModuleService extends Service {
	private static final String TAG = "MonotoneSweepModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			MonotoneSweepModule aim = new MonotoneSweepModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("MonotoneSweepModule");
	}
