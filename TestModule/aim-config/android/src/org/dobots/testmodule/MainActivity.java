...
import org.dobots.testmodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.testmodule", "org.dobots.testmodule.aim.TestModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (TestModuleService.class.getName().equals(service.service.getClassName())) {
