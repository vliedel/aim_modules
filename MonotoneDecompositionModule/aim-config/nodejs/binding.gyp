...
#
{
	"targets": [
		{
			"target_name": "MonotoneDecompositionModule",
			...
			"sources":[
				"../../aim-core/src/MonotoneDecompositionModule.cpp",
				"MonotoneDecompositionModuleNode.cc",
				"../../src/MonotoneDecompositionModuleExt.cpp"
			],
		}
	]
}
