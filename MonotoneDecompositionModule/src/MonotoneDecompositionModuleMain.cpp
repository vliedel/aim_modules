/**
 * @file MonotoneDecompositionModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the MonotoneDecompositionModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	MonotoneDecompositionModuleExt *m = new MonotoneDecompositionModuleExt();
