...
#ifndef IMAGEDISPLAYMODULE_H_
#define IMAGEDISPLAYMODULE_H_
...
private:
  ...
  static void* readCommandsHelper(void* object) {
    ((ImageDisplayModule*)object)->readCommands();
    return NULL;
  }
...
public:
  ...
  // Default destructor
  virtual ~ImageDisplayModule();
  
  // Extend this with your own code, first call ImageDisplayModule::Init(name);
