...
import org.dobots.imagedisplaymodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.imagedisplaymodule", "org.dobots.imagedisplaymodule.aim.ImageDisplayModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (ImageDisplayModuleService.class.getName().equals(service.service.getClassName())) {
