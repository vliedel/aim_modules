package org.dobots.imagedisplaymodule.aim;
...
public class ImageDisplayModuleService extends Service {
	private static final String TAG = "ImageDisplayModuleService";
	private static final String MODULE_NAME = "ImageDisplayModule";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			ImageDisplayModule aim = new ImageDisplayModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("ImageDisplayModule");
	}
