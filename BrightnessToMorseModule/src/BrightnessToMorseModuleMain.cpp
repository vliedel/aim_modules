/**
 * @file BrightnessToMorseModuleMain.cpp
 * @brief Entry function for BrightnessToMorseModule
 *
 ...
 * have this file and the BrightnessToMorseModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	BrightnessToMorseModuleExt *m = new BrightnessToMorseModuleExt();
