...
private:
  ...
  float portBrightnessValue;
  zmq_socket_ext portBrightnessIn;
  
  zmq_socket_ext portMorseOut;
  
  static void* readCommandsHelper(void* object) {
    ((BrightnessToMorseModule*)object)->readCommands();
    return NULL;
  }
...
public:
  ...
  /**
   * The "readBrightness" function receives stuff over a zeromq REP socket. It works as a client. It is better not
