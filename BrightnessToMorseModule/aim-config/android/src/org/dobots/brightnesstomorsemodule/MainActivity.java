package org.dobots.brightnesstomorsemodule;
...
import org.dobots.brightnesstomorsemodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.brightnesstomorsemodule", "org.dobots.brightnesstomorsemodule.aim.BrightnessToMorseModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (BrightnessToMorseModuleService.class.getName().equals(service.service.getClassName())) {
