...
The ExpectationMaximizationModule read samples, train a gaussian mixture model. It will output the means, covariances and weights of the gaussians.
After training, new samples can be classified.

## How fast is it?

A set with 4177 samples, 10 features and 28 clusters took about 18s to train.
