/**
 * @file ExpectationMaximizationModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the ExpectationMaximizationModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	ExpectationMaximizationModuleExt *m = new ExpectationMaximizationModuleExt();
