	...
	"targets": [
		{
			...
			"libraries": [
				...
				"/opt/ros/hydro/lib/libopencv_core.so",
				"/opt/ros/hydro/lib/libopencv_ml.so",
			],
			...
			"sources":[
				"../../aim-core/src/ExpectationMaximizationModule.cpp",
				"ExpectationMaximizationModuleNode.cc",
