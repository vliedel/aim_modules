...
//import org.dobots.avgbrightnessmodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.avgbrightnessmodule", "org.dobots.avgbrightnessmodule.AvgBrightnessModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (AvgBrightnessModuleService.class.getName().equals(service.service.getClassName())) {
