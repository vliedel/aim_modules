package org.dobots.facerecogmodule.aim;
...
public class FaceRecogModuleService extends Service {
	private static final String TAG = "FaceRecogModuleService";
	private static final String MODULE_NAME = "FaceRecogModule";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			FaceRecogModule aim = new FaceRecogModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("FaceRecogModule");
	}
