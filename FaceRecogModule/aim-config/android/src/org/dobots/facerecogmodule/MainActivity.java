...
import org.dobots.facerecogmodule.aim.*;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.facerecogmodule", "org.dobots.facerecogmodule.aim.FaceRecogModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (FaceRecogModuleService.class.getName().equals(service.service.getClassName())) {
