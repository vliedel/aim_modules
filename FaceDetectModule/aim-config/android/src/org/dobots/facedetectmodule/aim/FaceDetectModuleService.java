package org.dobots.facedetectmodule.aim;
...
public class FaceDetectModuleService extends Service {
	private static final String TAG = "FaceDetectModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			FaceDetectModule aim = new FaceDetectModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("FaceDetectModule");
	}
