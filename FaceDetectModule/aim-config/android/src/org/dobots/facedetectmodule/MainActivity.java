package org.dobots.facedetectmodule;
...
import org.dobots.facedetectmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "FaceDetectModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.facedetectmodule", "org.dobots.facedetectmodule.aim.FaceDetectModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (FaceDetectModuleService.class.getName().equals(service.service.getClassName())) {
