...
#ifndef FACEDETECTMODULE_H_
#define FACEDETECTMODULE_H_
...
private:
  ...
  zmq_socket_ext portFaceImageOut;
  
  static void* readCommandsHelper(void* object) {
    ((FaceDetectModule*)object)->readCommands();
    return NULL;
  }
...
public:
  ...
  // Extend this with your own code, first call FaceDetectModule::Init(name);
  ...
  /**
   * The "writeFaceImage" function sends stuff over a zeromq REQ socket. It works as a server. It cannot be blocking because this
  ...
  bool writeFaceImage(const long_seq &bmp);
  
};
} // End of namespace

#endif // FACEDETECTMODULE_H_
