package org.dobots.motiondetectionmodule.aim;
...
public class MotionDetectionModuleService extends Service {
	private static final String TAG = "MotionDetectionModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			MotionDetectionModule aim = new MotionDetectionModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("MotionDetectionModule");
	}
