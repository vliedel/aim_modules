package org.dobots.motiondetectionmodule;
...
import org.dobots.motiondetectionmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "MotionDetectionModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.motiondetectionmodule", "org.dobots.motiondetectionmodule.aim.MotionDetectionModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (MotionDetectionModuleService.class.getName().equals(service.service.getClassName())) {
